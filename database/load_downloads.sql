...
INSERT INTO invoice (invoice_id, user_id, invoice_date, total_amount, is_processed) VALUES 
  (1, 1, timestamp '2008-05-01 00:00:00',  12.99, 'n');
INSERT INTO invoice (invoice_id, user_id, invoice_date, total_amount, is_processed) VALUES 
  (2, 3, timestamp '2009-05-01 00:00:00',  9.99, 'n');